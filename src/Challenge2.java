public class Challenge2 {
	...
	public static double factorial(int n) {
		...
		/*
		 * Complete this method to calculate the factorialorial of an input number 'n'
		 */
		//return result;
	}
	...
	public static void main(String arg[]) {
		...
		System.out.println("factorialorial of 2 is : " + res1);

		double res2 = factorial(4);
		System.out.println("factorialorial of 140 is : " + res2);

		double res3 = factorial(6);
		System.out.println("factorialorial of 6 is : " + res3);

		double res4 = factorial(8);
		System.out.println("factorialorial of 8 is : " + res4);
